...
// 声色エモート: 20感情を「喜・怒・哀・楽・通常」の5バケットに分類。
// admin でバケットごとにVoiceVoxスタイルIDを割り当て、_agruResolveVoiceSpeaker で解決する。
const AGRU_EMOTION_VOICE_BUCKET = {
  '安心':'normal','愛しさ':'joy','感謝':'joy','性的興奮':'fun','興奮':'fun','感動':'joy','好奇心':'fun','驚き':'fun','尊敬':'joy','不安':'sorrow',
  '恐怖':'sorrow','困惑':'sorrow','冷静':'normal','軽蔑':'anger','殺意':'anger','悲しみ':'sorrow','諦め':'sorrow','苦しみ':'sorrow','嫉妬':'anger','恥':'joy',
};
